    ...
    <main className="grain relative flex h-dvh flex-col overflow-hidden bg-black md:flex-row">
      ...
      >
        ...
        <div className={contentClass("barber")}>
          ...
          >
            <StudiosWordmark
              widthClassName="w-[64vw] max-w-[340px] md:w-[30vw] md:max-w-[420px]"
              priority
              glow
            />
      ...
      >
        ...
        <div className={contentClass("ink")}>
          <motion.span style={{ x: inkParallax.springX, y: inkParallax.springY }}>
            <InkWordmark
              widthClassName="w-[58vw] max-w-[300px] md:w-[24vw] md:max-w-[380px]"
              priority
              glow
            />
          </motion.span>
